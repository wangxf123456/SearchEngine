...
{else}
<h1>You have not logged in or you do not have access to this user's albums.<br> Click <a href="/rgrnke/pa2/login?url=_rgrnke_pa2_albums_edit?username={$ownername}">here</a> to go to login</h1>
{/if}
{/block}
