...
//				System.out.println(value.toString());
				...
				Nodes nodeId = doc.query("//eecs485_from");
				strId = nodeId.get(0).getChild(0).getValue();
				
				Nodes nodeBody = doc.query("//eecs485_to");
	...
	public static void main(String[] args) throws Exception
	{
		...
		conf.set("xmlinput.start", "<eecs485_edge>");
		conf.set("xmlinput.end", "</eecs485_edge>");
